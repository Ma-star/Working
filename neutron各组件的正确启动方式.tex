...
\subsection{启动命令如下}
    \begin{itemize}
		...
		\item[4.]neutron-metadata-agent的启动方式：
			begin{lstlisting}
		...
		\item[5.]neutron-openvswitch-agent的启动方式：
			begin{lstlisting}
				neutron-openvswitch-agent --config-file=/etc/neutron/neutron.conf \
			  --config-file=/etc/neutron/plugins/ml2/openvswitch_agent.ini \
			  --log-file=/var/log/neutron/openvswitch-agent.log 
			end{lstlisting}
    \end{itemize}
\subsection{激活virtualenv:source /root/wgzhou/test/bin/activate}
\end{document}